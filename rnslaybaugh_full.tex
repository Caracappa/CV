...
Tools & EC2, Doxygen, \LaTeX, MathCAD, Mathematica, shell, vim, bash, \\&Emacs, Jupyter, Trilinos, LAPACK, MPI, Valgrind\\
Nuclear Software & Exnihilo, ADVANTG, MCNP, Serpent, SCALE, PyNE
\end{tabular}
